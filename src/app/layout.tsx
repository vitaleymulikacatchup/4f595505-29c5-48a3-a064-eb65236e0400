...
export const metadata: Metadata = {
  title: "BVB Fans Shop - Official Borussia Dortmund Merchandise",
  description: "Official BVB merchandise store for true Borussia Dortmund supporters. Authentic jerseys, scarves, accessories and exclusive fan community membership.",
  keywords: "BVB, Borussia Dortmund, merchandise, jersey, scarf, fans, official store, football, soccer, bundesliga",
  metadataBase: new URL("https://bvb-fans-shop.com"),
  alternates: {
    canonical: "https://bvb-fans-shop.com"
  },
  openGraph: {
    title: "BVB Fans Shop - Official Borussia Dortmund Merchandise",
    description: "Official BVB merchandise store for true Borussia Dortmund supporters. Join the yellow wall community today!",
    url: "https://bvb-fans-shop.com",
    siteName: "BVB Fans Shop",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1763033957563-ppt739hz.jpg",
        alt: "BVB Signal Iduna Park stadium"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "BVB Fans Shop - Official Borussia Dortmund Merchandise",
    description: "Official BVB merchandise store for true Borussia Dortmund supporters.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1763033957563-ppt739hz.jpg"]
  },
  robots: {
    index: true,
    follow: true
